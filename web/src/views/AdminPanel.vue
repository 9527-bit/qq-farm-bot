...
import AdminManagementSystemPanel from '@/components/admin/AdminManagementSystemPanel.vue'
...
import { useAdminManagementConfig } from '@/composables/useAdminManagementConfig'
...
} = useAdminManagementConfig({ showAlert })
